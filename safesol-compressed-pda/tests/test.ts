...
import { SafesolCompressedPda } from "../target/types/safesol_compressed_pda";
import idl from "../target/idl/safesol_compressed_pda.json";
import {
  bn,
...
describe("test-anchor", () => {
  const program = anchor.workspace.SafesolCompressedPda as Program<SafesolCompressedPda>;
...
async function CreateCounterCompressedAccount(
  ...
  program: anchor.Program<SafesolCompressedPda>,
