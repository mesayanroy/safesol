...
export default function DashboardPage() {
  ...
  const { transactions, stats, limits, changeFilter, clearHistory, exportHistory } = useTransactionHistory();
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          <span className="text-xs font-semibold">
                            {limits.dailyCrossBorderSpent.toFixed(2)} / {limits.dailyCrossBorderLimit} SOL
                          </span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-1.5">
                        <div className="bg-white/10 rounded-lg px-2.5 py-1.5">
                          ...
                          <p className="text-base font-bold">
                            {Math.max(0, limits.dailyCrossBorderLimit - limits.dailyCrossBorderSpent).toFixed(2)} SOL
                          </p>
                        </div>
                        <div className="bg-white/10 rounded-lg px-2.5 py-1.5">
...
function StatCard({
  ...
  const colorClasses = {
    ...
    green: 'from-green-100 to-green-50 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800 text-green-900 dark:text-green-100',
    ...
    purple: 'from-purple-100 to-purple-50 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800 text-purple-900 dark:text-purple-100',
  };
  ...
  return (
    <div className={`bg-gradient-to-br ${colorClasses[color]} rounded-xl p-3 border`}>
      ...
      <div className="flex items-center justify-between">
        <p className="text-xl sm:text-2xl font-bold">{value}{isSol ? ' SOL' : ''}</p>
