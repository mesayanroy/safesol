        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <code className="text-xs sm:text-sm font-mono bg-stone-100 dark:bg-stone-900 px-2.5 sm:px-3 py-1.5 rounded-lg text-stone-900 dark:text-stone-50 flex-1 truncate">
                {publicKey.toString()}
              </code>
              <button
                onClick={() => copyToClipboard(publicKey.toString())}
                className="p-1.5 rounded-lg hover:bg-stone-100 dark:hover:bg-stone-900 transition"
              >
                {copied ? (
          ...
          <div>
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-base sm:text-lg font-semibold text-stone-600 dark:text-stone-400">
                SOL
              </span>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-stone-200 dark:border-stone-800">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-300 rounded-full text-[10px] sm:text-xs font-semibold">
                <span>✓</span>
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-stone-950 rounded-xl p-4 border border-stone-200 dark:border-stone-800">
            ...
            <p className="text-xl sm:text-2xl font-bold text-stone-900 dark:text-stone-50">
